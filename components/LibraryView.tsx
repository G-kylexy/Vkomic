...
const LibraryView: React.FC<LibraryViewProps> = ({ downloadPath }) => {
  ...
  return (
    <div className="flex-1 flex flex-col px-6 pb-10 pt-6 overflow-hidden">
              ...
              <React.Fragment key={crumb.path}>
                ...
                <button
                  ...
                  className={`hover:text-white transition-colors ${
                    index === breadcrumbs.length - 1 ? 'text-white font-semibold cursor-default' : ''
                  }`}
      ...
      {!isLoading && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 overflow-y-auto pr-2 custom-scrollbar pb-4">
          {entries.map((entry) => {
