    ...
    <div className="flex-1 p-8 flex flex-col pt-6 animate-fade-in overflow-y-auto custom-scrollbar">
      <div className="w-full max-w-6xl flex flex-col">
        ...
        <div className="mt-2 mb-6 flex items-center justify-between text-sm min-h-[32px]">
          <div className="flex items-center gap-2 overflow-x-auto flex-nowrap flex-1 min-w-0 pr-2">
            {!isSearching && (
              <>
                <button
                  onClick={clearNav}
        ...
        <div className="flex-1 relative">
          ...
          {fileNodes.length > 0 && (
            <div className="bg-[#0f1523] border border-[#1e293b] rounded-xl shadow-lg overflow-hidden">
