...
const BrowserView: React.FC<BrowserViewProps> = ({ vkToken, syncedData, setSyncedData, searchQuery, onVkStatusChange }) => {
              ...
              >
                ...
                <div className="flex-1 mb-4">
                    ...
                    <div className="flex items-center gap-2 text-xs text-slate-400 mb-1">
                        ...
                        <span className="capitalize text-slate-400">{isFolder ? t.library.folderLabel : t.library.fileLabel}</span>
                    </div>
                </div>
